      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            {
              test: lessRegex,
              exclude: /node_modules|antd\.css|antd\.less|ant-design-pro\.css|ant-design-pro\.less|default\.less|default\.css/,
              use: getStyleLoaders(
                {
                  importLoaders: 2,
                  sourceMap: isEnvProduction && shouldUseSourceMap,
            ...
            {
              test: antProRegex,
              include: /node_modules|ant-design-pro\.css|ant-design-pro\.less/,
              use: getStyleLoaders(
              {
                importLoaders: 2,
                sourceMap: isEnvProduction && shouldUseSourceMap
