...
class Basiccolumn extends React.Component {
  ...
  componentDidMount(){
    this.context.updateTitle("单堆叠柱状图页面")
  }
  render() {
    const data = [
      {
    ...
    return (
      <div className='outer-his-page-container'>
        <Chart height={400} data={dv} scale={cols} forceFit filter={[
            ['item',(val)=>{
          ...
          />
          <Geom type="interval" position="date*value" color='item'/>
        </Chart>
      </div>
    );
  }
